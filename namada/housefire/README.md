...
cd namada
wget https://github.com/anoma/namada/releases/download/v0.30.3/namada-v0.30.3-Linux-x86_64.tar.gz
tar -xvf namada-v0.30.3-Linux-x86_64.tar.gz
rm namada-v0.30.3-Linux-x86_64.tar.gz
cd namada-v0.30.3-Linux-x86_64
